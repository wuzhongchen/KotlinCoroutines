...
import com.dongnaoedu.flowpractice.utils.ListActionSectionConverter
import com.dongnaoedu.flowpractice.utils.ListStringConverter
/**
 *
 * @author ningchuanqi
 * @version V1.0
 */
@Entity
@TypeConverters(ListStringConverter::class, ListActionSectionConverter::class)
data class User(
    @PrimaryKey
    var bid: String,
    var status: Int= 0,
